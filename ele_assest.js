...
async function lybamount(cookie) {
  const _0x4e034e = {
    authority: "mtop.ele.me",
    accept: "application/json",
    "accept-language": "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7",
  ...
  const _0x2b5c72 = 12574478;
  var _0x1a5ddd = "data=" + encodeURIComponent(JSON.stringify(_0x1d1a7b));
  const _0x267792 = getToken(cookie),
    _0x1c4025 = _0x267792.split("_")[0];
  const _0x26ba75 = await sign(_0x1c4025 + "&" + _0xa0411f + "&" + _0x2b5c72 + "&" + JSON.stringify(_0x1d1a7b), _0x46e8ae);
  const _0x421606 = {
    url: "https://mtop.ele.me/h5/mtop.koubei.interaction.center.common.queryintegralproperty.v2/1.0/5.0/?jsv=2.7.2&appKey=12574478&t=" + _0xa0411f + "&sign=" + _0x26ba75 + "&api=mtop.koubei.interaction.center.common.queryintegralproperty.v2&v=1.0",
    method: "POST",
    headers: _0x4e034e,
    body: _0x1a5ddd
  };
  return tryCatchPromise(resolve => {
  _0x43a291(_0x421606, async (error, response, body) => {
    if (!error && response.statusCode === 200) {
      try {
        const jsonResponse = JSON.parse(body);

        if (jsonResponse.data && jsonResponse.data.data) {
          const count = jsonResponse.data.data["1404"]?.count || 0;  
          resolve(count);  
        } else {
          resolve(0);  
        }
...
async function _0x163ae7() {
  ...
  for (let _0x3913fc = 0; _0x3913fc < _0x31839a.length; _0x3913fc++) {
   ...
   var _0x4b0682 = await lybamount(_0x1e1848);
    if (!_0x4b0682) {
      _0x4b0682 = _0x55733f;
    }
    //let maskedMobile = _0x17b596.mobile.substring(0, 3) + "****" + _0x17b596.mobile.substring(7);
    console.log("手机号：" +_0x17b596.encryptMobile);
    console.log("今日共获得乐园币：" + _0x30b429);
    console.log("账户总乐园币：" + _0x4b0682);
